...
template <typename T> class SimpleDataWrapper {
private:
	T mdata;
public:
...
template <> class SimpleDataWrapper <char*> {
private: 
	char* mdata;
public:
...
template<> class SimpleDataWrapper <Point<int>> {
private:
	Point<int> mdata;
public:
...
/*
	...
	특정 자료형을 기반으로 생성된 객체에 대해 구분이 되는 다른 행동양식을 적용한다.
*/